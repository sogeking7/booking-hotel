...
public class Countries extends TableImpl<CountrieRecord> {
     ...
     */
    @Override
    public Class<CountrieRecord> getRecordType() {
        return CountrieRecord.class;
    }

    /**
     * The column <code>public.countries.id_</code>.
     */
    public final TableField<CountrieRecord, Long> ID = createField(DSL.name("id_"), SQLDataType.BIGINT.nullable(false).identity(true), this, "");

    /**
     * The column <code>public.countries.created_at_</code>.
     */
    public final TableField<CountrieRecord, OffsetDateTime> CREATED_AT = createField(DSL.name("created_at_"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false).defaultValue(DSL.field(DSL.raw("now()"), SQLDataType.TIMESTAMPWITHTIMEZONE)), this, "");

    /**
     * The column <code>public.countries.updated_at_</code>.
     */
    public final TableField<CountrieRecord, OffsetDateTime> UPDATED_AT = createField(DSL.name("updated_at_"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false).defaultValue(DSL.field(DSL.raw("now()"), SQLDataType.TIMESTAMPWITHTIMEZONE)), this, "");
     ...
     */
    public final TableField<CountrieRecord, String> NAME = createField(DSL.name("name_"), SQLDataType.VARCHAR(50).nullable(false), this, "");

    /**
     * The column <code>public.countries.code_</code>.
     */
    public final TableField<CountrieRecord, String> CODE = createField(DSL.name("code_"), SQLDataType.VARCHAR(5).nullable(false), this, "");

    /**
     * The column <code>public.countries.currency_</code>.
     */
    public final TableField<CountrieRecord, String> CURRENCY = createField(DSL.name("currency_"), SQLDataType.VARCHAR(5).nullable(false), this, "");

    private Countries(Name alias, Table<CountrieRecord> aliased) {
        this(alias, aliased, (Field<?>[]) null, null);
    }

    private Countries(Name alias, Table<CountrieRecord> aliased, Field<?>[] parameters, Condition where) {
    ...
    @Override
    public Identity<CountrieRecord, Long> getIdentity() {
        return (Identity<CountrieRecord, Long>) super.getIdentity();
    }

    @Override
    public UniqueKey<CountrieRecord> getPrimaryKey() {
