...
public class Main {
	...
	public static void main(String[] args) throws Exception {
		...
		Boolean todoEnabled = Boolean.valueOf(properties.getProperty("todo.enabled", "false"));
		if (todoEnabled) {
			generate("todo.", properties);
		}
	}
	...
	private static void generate(String prefix, Properties properties) throws Exception {
		...
		Generator generator = new Generator()
			...
			.withStrategy(new Strategy()
				.withName("org.todo.jooq.codegen.CustomGeneratorStrategy")
			)
